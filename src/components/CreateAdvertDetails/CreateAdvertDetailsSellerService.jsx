        ...
        <Col>
          <Card className={styles.cardstyle}>
            ...
            >
              ...
              <Form.Item
                name="3d_printer_model"
                label={<label className={styles.label}>3D Printer Model</label>}
                labelCol={{ span: 24 }}
                rules={[
                  {
                    required: true,
                    message: "Please input 3D printer model.",
                  },
                ]}
              >
                <Input
                  ...
                  onChange={(e) => {
                    setAdvert({ ...advert, printer_model: e.target.value });
                  }}
                />
              </Form.Item>
              <Form.Item
                name="colors"
                label={<label className={styles.label}>Avaliable Filament Colors</label>}
                labelCol={{ span: 24 }}
                rules={[
                  {
                    required: true,
                    message: "Please select avaliable filament colors.",
                  },
                ]}
              >
                <Select
                  ...
                  onChange={(values) => {
                    setAdvert({ ...advert, colors: values });
                  }}
                >
              ...
              <Form.Item
                name="max_size"
                label={<label className={styles.label}>Max Available Size - Format: WidthxLengthxHeight</label>}
                labelCol={{ span: 24 }}
                rules={[
                  {
                    required: true,
                    message: "Please input max available size.",
                  },
                  {
                    validator: (_, value) => {
              ...
              >
                <Input
                  ...
                  suffix="cm"
                  placeholder="Max Available Size"
                  onChange={(e) => {
...
export default CreateAdvertDetailsSellerService;